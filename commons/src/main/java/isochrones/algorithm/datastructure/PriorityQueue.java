...
/**
 * PriorityQueue interface. Some priority queues may support a decreaseKey operation, but this is considered an advanced
 * operation. If so, a Position is returned by insert. Note that all "matching" is based on the compareTo method.
 * 
...
public interface PriorityQueue {
  ...
  /**
   * Change the value of the item stored in the pairing heap. This is considered an advanced operation and might not be
   * supported by all priority queues. A priority queue will signal its intention to not support decreaseKey by having
   * insert return null consistently.
   * 
